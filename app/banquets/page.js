...
import { BANQUETS_INTRO, EVENT_SPACES } from "@/lib/data/banquets";
...
export const metadata = {
  ...
  description: `Banquet halls, conference facilities and event spaces at ${SITE.name}, Rohtak.`,
        ...
        <Container>
          ...
          <Reveal delay={0.12}>
            <div className="flex flex-wrap justify-center gap-4.5">
              ...
              <Button href={`tel:${CONTACT.phones[0].replace(/\s+/g, "")}`} variant="ghostLight">
                {CONTACT.phones[0]}
              </Button>
            </div>
          </Reveal>
