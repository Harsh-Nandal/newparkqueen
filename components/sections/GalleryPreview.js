        ...
        <div className="grid grid-flow-dense grid-cols-2 gap-4.5 md:grid-cols-4">
          {items.map((item, i) => (
            ...
            >
              ...
              />
              <div className="absolute inset-0 flex items-end bg-gradient-to-t from-navy-deep/60 via-transparent to-transparent p-4 opacity-0 transition-opacity duration-500 group-hover:opacity-100">
